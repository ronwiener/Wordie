...
import Header1 from "./components/SixHeader";
import Tile1 from "./components/SixTile";
import Keyboard1 from "./components/SixKeyboard";
import Buttons1 from "./components/SixButtons";
...
class AppSix extends React.Component {
  ...
  keyboardType = (keyClicked) => {
    ...
    if (guessBox && !gameOver) {
      if (keyClicked === "Enter" && guessBox.value.length >= 6) {
        ...
        if (guessBox.value.length <= 6) {
          ...
          errorMessage = "We're only looking for 6-digit words";
          currentGuess = "";
          guessBox.value = "";
          this.setState({
            errorMessage: errorMessage,
    ...
    return (
      <div className="App">
        <header className="Header">
          <Header1 errorMessage={this.state.errorMessage} />
          ...
          <Buttons1 resetGame={this.resetGame} />
        </header>
      </div>
    );
  }
